...
import liu.util.concurrent.AbstractExecutorService;
import liu.util.concurrent.Callable;
import liu.util.concurrent.ExecutorService;
import liu.util.concurrent.Future;
import liu.util.concurrent.RejectedExecutionException;
import liu.util.concurrent.RunnableFuture;
import liu.util.concurrent.ThreadLocalRandom;
import liu.util.concurrent.TimeUnit;
import liu.util.concurrent.atomic.AtomicLong;
 ...
 * <ul>
 * <li>{@code liu.util.concurrent.ForkJoinPool.common.parallelism}
 * - the parallelism level, a non-negative integer
 * <li>{@code liu.util.concurrent.ForkJoinPool.common.threadFactory}
 * - the class name of a {@link ForkJoinWorkerThreadFactory}
 * <li>{@code liu.util.concurrent.ForkJoinPool.common.exceptionHandler}
    ...
    private static ForkJoinPool makeCommonPool() {
        ...
        try {  // ignore exceptions in accessing/parsing properties
            String pp = System.getProperty
                ("liu.util.concurrent.ForkJoinPool.common.parallelism");
            String fp = System.getProperty
                ("liu.util.concurrent.ForkJoinPool.common.threadFactory");
            String hp = System.getProperty
                ("liu.util.concurrent.ForkJoinPool.common.exceptionHandler");
            if (pp != null)
